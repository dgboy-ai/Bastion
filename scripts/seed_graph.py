...
CONN = (
    "postgresql://divyansh:7_GfcNnRnL6UaflljIzOIw@"
    "bastion-memory-28736.j77.aws-ap-south-1.cockroachlabs.cloud:26257/"
...
memories = [
    (
        ...
        "fact",
        (
            "Alice is the Lead Systems Architect who works on systems "
            "programming using Rust and coordinates core logic."
        ),
        8.5,
    ...
    (
        ...
        "fact",
        (
            "Bob is a Senior Frontend Developer building the main "
            "operational cockpit using Next.js."
        ),
        7.8,
    ...
    (
        ...
        "fact",
        (
            "Bob is learning systems programming in Rust to help write "
            "efficient SDK bindings for the database layer."
        ),
        6.5,
