...
for t in ["agent_memory", "agent_audit", "agent_keys", "a2a_tasks",
          "agent_entities", "agent_relations", "thought_graph", "push_notification_log"]:
...
indexes = [dict(zip(cols, r)) for r in cur.fetchall()]
