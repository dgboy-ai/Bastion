...
def t_store_types():
    for mt in ["procedural", "preference", "system_event", "security", "thought_node", "saga", "conversation", "task", "learned", "semantic"]:
...
clean = ["Deployment completed successfully", "Hello world", "The weather is nice", "Memory stored at 3pm", "User prefers dark mode"]
...
from bastion.memory import _validate_memory_type, _validate_content, _validate_agent_id, _validate_k
